    ...
    <>
      ...
      >
        <div className="mx-auto flex h-full max-w-7xl items-center justify-between px-4 md:px-8">
          {/* Logo */}
          <a href={`/${locale}#home`} className="shrink-0">
            <Image
              src="/gutsy-logo.png"
              alt={nav.logo}
              width={120}
          ...
          <nav className="hidden items-center gap-6 md:flex">
            ...
            <button
              ...
              className="cursor-pointer rounded-lg bg-orange-600 px-4 py-1.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-orange-700"
            >
              {nav.cta}
            </button>
          </nav>
      ...
      >
        <nav className="flex flex-col gap-3 px-4 py-4">
          ...
          <button
            onClick={() => scrollTo("contact")}
            className="mt-1 rounded-lg bg-orange-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-orange-700"
          >
            {nav.cta}
          </button>
        </nav>
