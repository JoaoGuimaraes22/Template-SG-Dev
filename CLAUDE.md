...
templates/
  presets/
    ...
    portfolio/      Hero, Services, Process, About, Contact
...
testimonials/scrolling/ Scrolling multi-column testimonial cards (portfolio + business)
...
stats/counters/         RAF-eased animated counters, IntersectionObserver (portfolio + business) [src: mrbig]
contact/map/            Google Maps iframe + address + directions; YOUR_MAPS_EMBED_URL (business) [src: mrbig]
team/spotlight/         2-col parallax image, glassmorphic stats overlay, tags + quote (portfolio + business) [src: mrbig]
```
...
```
YOUR_NAME / YOUR_EMAIL / YOUR_GITHUB / YOUR_LINKEDIN / YOUR_DOMAIN         (portfolio base)
YOUR_CITY / YOUR_TIMEZONE                                                   (portfolio sidebar)
